    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} ref={form}>
                ...
                <section className="vh-100 bg-image" s>
                            ...
                            <div className="card" style={{backgroundColor:"#eee"}} >
                                <div className="card-body p-5">
                                    ...
                                    <div className="form-outline mb-4">
                                        ...
                                        <label className="form-label" htmlFor="form3Example1cg"><b>Identificación</b></label>
                                        <input type="number" id="form3Example0cg" className="form-control" name='identificacion' placeholder='Minimo 5 digitos y maximo 10' onChange={handleChange} onClick={idError} />
                                    ...
                                    <div className="form-outline mb-4">
                                        ...
                                        <label className="form-label" htmlFor="form3Example1cg" ><b>Nombre</b></label>
                                        <input type="text" id="form3Example1cg" className="form-control" name='nombres' placeholder='Mínimo de 3 caracteres' onChange={handleChange} onClick={nombreError} />
                                        {nomError ? <p>El nombre debe contener mínimo 3 caracteres</p> : ""}

                                    </div>

                                    <div className="form-outline mb-4">
                                        <label className="form-label" htmlFor="form3Example1cg"><b>Apellido</b></label>
                                        <input type="text" id="form3Example2cg" className="form-control form-control-lg" name='apellidos' placeholder='Mínimo de 3 caracteres' onChange={handleChange} onClick={apelliError} />
                                        {apellidoError ? <p>El apellido debe contener mínimo 3 caracteres</p> : ""}

                                    </div>

                                    <div className="form-outline mb-4">
                                        <label className="form-label" htmlFor="form3Example3cg"><b>Email</b></label>
                                    ...
                                    <div className="form-outline mb-4">
                                        <label className="form-label" htmlFor="form3Example3cg"><b>Dirección</b></label>
                                        <input type="text" id="form3Example4cg" className="form-control form-control-lg" name='direccion' placeholder='Mínimo 15 caracteres' onChange={handleChange} onClick={dirError} />
                                        {direccionError ? <p>La dirección debe contener mínimo 15 caracteres</p> : ""}

                                    </div>

                                    <div className="form-outline mb-4">
                                        <label className="form-label" htmlFor="form3Example3cg"><b>Teléfono</b></label>
                                    ...
                                    <div className="form-outline mb-4">
                                        <label className="form-label" htmlFor="form3Example4cg"><b>Contraseña</b></label>
                                    ...
                                    <div className="form-outline mb-4">
                                        <label className="form-label" htmlFor="form3Example4cdg"><b>Repite la Contraseña</b></label>
                                    ...
                                    <div className="d-flex justify-content-center">
                                        <button type='submit' className="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><b>Registrar</b></button>
                                    </div>
                                   
                                        <p className="text-center text-muted mt-5 mb-0"><b>Have already an account?</b> <a href="#!" className="fw-bold text-body"><u><Link to='/login'><b>Login here</b> </Link></u></a></p>
