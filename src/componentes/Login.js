                                ...
                                <div className="card shadow-2-strong rounded" >
                                    <div className="card-body p-5 text-center">
                                        ...
                                        <div className="form-outline mb-4">
                                            <label className="form-label" for="typeEmailX-2"><b> Email </b></label>
                                            <input type="email" id="typeEmailX-2" className="form-control form-control-lg" name='email' onChange={handleChange} onClick={handleClickEmail} style={{fontFamily:"monospace"}} placeholder='Ingresa tu Correo'/>
                                            {errorEmail ? <p>Debe ingresar un email</p> : ""}
                                        </div>

                                        <div className="form-outline mb-4">
                                            <label className="form-label" for="typePasswordX-2"><b> Password </b></label>
                                            <input type="password" id="typePasswordX-2" className="form-control form-control-lg" name='password' onChange={handleChange} onClick={handleClickPassword} style={{fontFamily:"monospace"}} placeholder='Ingresa tu Contraseña'/>
                                        ...
                                        <div class="d-grid gap-2 col-15 mx-auto">
                                            <button className="btn  btn-lg btn-block" type="submit" style={{backgroundColor:"#18D2E1"}}>Login</button>
                                        </div>
